// features/Manager/Dashboard/RecentProjects.tsx
"use client";
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Latest project updates</p>
          </div>
          <Link
        ...
        {recentProjects.length === 0 ? (
          ...
          <div className="space-y-4">
            {recentProjects.map((project) => {
              ...
              return (
                <div key={project.id} className="group flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 transition-all duration-200 border border-transparent hover:border-gray-100">
